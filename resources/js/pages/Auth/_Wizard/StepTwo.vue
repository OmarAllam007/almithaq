...
let marriageStatuses = {
    husband: ['Single', 'Divorced', 'Widowed', 'Married'],
    wife: ['Single', 'Divorced', 'Widowed'],
};

// range from 18 to 90
let ageRange = Array.from({ length: 90 - 18 + 1 }, (_, i) => 18 + i);

let childCount = [0, 1, 2, 3, 4, 5, 6, 7, 8];
            ...
            <div class="fv-row mb-5">
                ...
                <div class="position-relative">
                    <input
                        ...
                        maxlength="20"
                    />
                    <span v-if="checkingUsername" class="position-absolute top-50 end-0 translate-middle-y me-3">
                                                        <span class="spinner-border spinner-border-sm text-primary"></span>
                                                    </span>
                    <span v-else-if="usernameAvailable === true" class="position-absolute top-50 end-0 translate-middle-y me-3">
                                                        <i class="ki-outline ki-check fs-2 text-success"></i>
                                                    </span>
                    <span v-else-if="usernameAvailable === false" class="position-absolute top-50 end-0 translate-middle-y me-3">
