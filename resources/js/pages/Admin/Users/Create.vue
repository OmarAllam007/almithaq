                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div class="text-gray-500 fs-6">Fill in the details to create a new user account</div>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-12">
                                    <div class="d-flex gap-8">
                                        <div class="form-check form-switch">
                                            <input v-model="form.is_active" type="checkbox" class="form-check-input" id="create_is_active" />
                                            <label class="form-check-label fw-semibold" for="create_is_active">Active Account</label>
                                        </div>
                                        <div class="form-check form-switch">
                                            <input v-model="form.is_verified" type="checkbox" class="form-check-input" id="create_is_verified" />
                                            <label class="form-check-label fw-semibold" for="create_is_verified">Verified</label>
                                        </div>
                                        <div class="form-check form-switch">
                                            <input v-model="form.is_admin" type="checkbox" class="form-check-input" id="create_is_admin" />
                                            <label class="form-check-label fw-semibold text-danger" for="create_is_admin">Admin</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
