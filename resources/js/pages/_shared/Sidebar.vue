        ...
        <div class="d-flex flex-stack px-lg-6 py-lg-8 px-4 py-3" id="kt_app_sidebar_logo">
            ...
            <div class="ms-3">
                ...
                <div class="position-relative symbol symbol-circle symbol-40px cursor-pointer"
                    ...
                    <img :src="$page.props.auth?.profile_image || '/assets/media/auth/no-image-for-user.png'" alt="user" />
                    ...
                    <div class="menu-item px-3">
                        <div class="menu-content d-flex align-items-center px-3">
                            ...
                            <div class="symbol symbol-50px me-5">
                                <img alt="Logo" :src="$page.props.auth?.profile_image || '/assets/media/auth/no-image-for-user.png'" />
                            </div>
                            <!--end::Avatar-->
                            <!--begin::Username-->
