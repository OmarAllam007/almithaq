...
const sections = computed(() => [
    { id: 's1', title: __('pages.terms-s1-title'), body: __('pages.terms-s1-body') },
    { id: 's2', title: __('pages.terms-s2-title'), body: __('pages.terms-s2-body') },
    { id: 's3', title: __('pages.terms-s3-title'), body: __('pages.terms-s3-body') },
    { id: 's4', title: __('pages.terms-s4-title'), body: __('pages.terms-s4-body') },
    { id: 's5', title: __('pages.terms-s5-title'), body: __('pages.terms-s5-body') },
    { id: 's6', title: __('pages.terms-s6-title'), body: __('pages.terms-s6-body') },
    { id: 's7', title: __('pages.terms-s7-title'), body: __('pages.terms-s7-body') },
    { id: 's8', title: __('pages.terms-s8-title'), body: __('pages.terms-s8-body') },
    { id: 's9', title: __('pages.terms-s9-title'), body: __('pages.terms-s9-body') },
    { id: 's10', title: __('pages.terms-s10-title'), body: __('pages.terms-s10-body') },
    { id: 's11', title: __('pages.terms-s11-title'), body: __('pages.terms-s11-body') },
    { id: 's12', title: __('pages.terms-s12-title'), body: __('pages.terms-s12-body') },
]);
...
<template>
    <Head>
        <title>{{ __('pages.nav-terms') }} — Khotobah</title>
    </Head>
        ...
        <section class="legal-hero">
            ...
            <div class="shell legal-hero__inner">
                <span class="eyebrow reveal">
                    <span class="eyebrow__diamond"></span>{{ __('pages.terms-eyebrow') }}
                </span>
                <h1 class="page-title legal-hero__title reveal">
                    <span class="line">{{ __('pages.terms-hero-title-1') }}</span>
                    <span class="line line--accent">{{ __('pages.terms-hero-title-2') }}</span>
                </h1>
                <p class="legal-hero__date reveal">{{ __('pages.terms-hero-desc') }}</p>
            </div>
        ...
        <section class="section legal-section">
            <div class="shell legal-body">
                ...
                <aside class="legal-toc">
                    <h3 class="legal-toc__title">{{ __('pages.terms-toc-title') }}</h3>
                    <nav>
                        <a
...
.legal-hero__glow {
    ...
    background: radial-gradient(ellipse, rgba(208,46,121,0.12), transparent 65%);
    filter: blur(50px);
...
/* ── Legal layout (mirrors Privacy.vue) ── */
...
.legal-toc nav a.is-active { color: var(--rose); border-inline-start-color: var(--rose); background: var(--blush); }
.legal-intro {
    background: var(--blush); border: 1px solid rgba(208,46,121,0.18);
    border-radius: 1rem; padding: 1.4rem 1.6rem; margin-bottom: 2.5rem;
}
.legal-intro p { font-size: 1rem; line-height: 1.75; color: var(--plum); margin: 0; font-style: italic; }
.is-ar .legal-intro p { font-style: normal; }
.legal-section-block { padding: 2rem 0; border-bottom: 1px solid var(--line); scroll-margin-top: 90px; }
.legal-section-block:last-of-type { border-bottom: none; }
.legal-section-block__title {
    font-family: 'Cormorant Garamond', 'Cairo', serif;
    font-size: 1.5rem; font-weight: 600; color: var(--plum); margin: 0 0 0.9rem; line-height: 1.2;
}
.is-ar .legal-section-block__title { font-family: 'Cairo', serif; }
.legal-section-block__body { font-size: 0.98rem; line-height: 1.8; color: rgba(44,10,24,0.72); margin: 0; }
.legal-contact-cta {
    display: flex; align-items: center; justify-content: space-between;
    gap: 1rem; flex-wrap: wrap;
    padding: 1.4rem 1.6rem;
    background: var(--cream-2); border-radius: 1rem; margin-top: 2rem;
}
